    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
              ...
              <div className="d-flex flex-row flex-lg-column">
                ...
                <div className="d-flex flex-column w-100 justify-content-start">
                  <div className={styles.skillContainer + " d-flex flex-column align-items-center"}>
                    <div className={styles.titlebox}>Frontend</div>
                ...
                <div className="d-flex flex-column w-100 justify-content-start">
                  <div className={styles.skillContainer + " d-flex flex-column align-items-center"}>
                    <div className={styles.titlebox}>Backend</div>
                    <div className="d-flex flex-column flex-lg-row">
            ...
            <div className="d-flex flex-column w-100 justify-content-start">
              <div className={styles.skillContainer + " d-flex flex-column align-items-center"}>
                <div className={styles.titlebox}>Machine Learning</div>
                <div className="d-flex flex-column flex-lg-row">
            ...
            <div className="d-flex flex-row">
              ...
              <div className="d-flex flex-column w-100 justify-content-start">
                <div className={styles.skillContainer + " d-flex flex-column align-items-center"}>
                  <div className={styles.titlebox}>Design</div>
                  <div className="d-flex flex-column flex-lg-row">
              ...
              <div className="d-flex flex-column w-100 justify-content-start">
                <div className={styles.skillContainer + " d-flex flex-column align-items-center"}>
                  <div className={styles.titlebox}>Other</div>
                  <div className="d-flex flex-column flex-lg-row">
